...
pub const FieldEnum = blk: {
    ...
    const IntTag = std.math.IntFittingRange(0, fields_len - 1);
    var field_names: [fields_len][]const u8 = undefined;
    var field_values: [fields_len]IntTag = undefined;
    var i: usize = 0;
    ...
    break :blk @Enum(IntTag, .exhaustive, &field_names, &field_values);
};
