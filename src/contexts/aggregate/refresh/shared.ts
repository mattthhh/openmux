/**
 * Shared refresh helpers for aggregate view.
 */
...
export interface EnrichedPtyMetadata extends PtyMetadata {
  sessionId?: string;
  sessionMetadata?: SessionMetadata;
}

/** Live PTY metadata with session ownership already resolved. */
export interface ResolvedPty extends EnrichedPtyMetadata {
  sessionId: string;
  sessionMetadata: SessionMetadata;
}
...
export function getSessionSummaryFromDetails(session: SerializedSession): SessionSummary {
