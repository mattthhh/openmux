...
export const DEFAULT_KEYBINDINGS: KeybindingsConfig = {
  ...
  prefix: {
    ...
    'shift+d': 'diff.opener.toggle',
    z: 'pane.zoom',
    a: 'pane.synchronize.toggle',
    ']': 'clipboard.paste',
    p: 'clipboard.paste',
    '`': 'console.toggle',
    q: 'app.quit',
  ...
  diffOpener: {
    down: 'diff.opener.down',
    up: 'diff.opener.up',
    enter: 'diff.opener.confirm',
    escape: 'diff.opener.close',
    backspace: 'diff.opener.delete',
  },
  templateOverlay: {
    apply: {
  ...
  aggregate: {
    list: {
      ...
      'alt+n': 'aggregate.list.new.pane',
      'alt+j': 'aggregate.list.down',
      'alt+k': 'aggregate.list.up',
